...
# python ./tools/export_model.py -c configs/ppyoloe/ppyoloe_crn_s_400e_coco.yml -o weights=output/ppyoloe_crn_s_400e_coco.pdparams  trt=True  exclude_nms=True TestReader.inputs_def.image_shape=[3,640,640] --output_dir output
# python ./tools/export_model.py -c configs/ppyoloe/ppyoloe_plus_crn_s_80e_coco.yml -o weights=output/ppyoloe_plus_crn_s_80e_coco.pdparams  --output_dir output
# python tools/export_model.py -c configs/picodet/picodet_s_320_coco_lcnet.yml -o weights=https://paddledet.bj.bcebos.com/models/picodet_s_320_coco_lcnet.pdparams --output_dir=output_inference